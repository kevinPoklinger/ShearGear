...
public class SimpleDatePickerDialogFragment extends DialogFragment {
    ...
    private com.example.kevin.sheargear.SimpleDatePickerDialog.OnDateSetListener mOnDateSetListener;
     ...
     */
    public void setOnDateSetListener(com.example.kevin.sheargear.SimpleDatePickerDialog.OnDateSetListener onDateSetListener) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        com.example.kevin.sheargear.SimpleDatePickerDialog simpleDatePickerDialog = new com.example.kevin.sheargear.SimpleDatePickerDialog(
