...
public class SimpleDatePickerDialog extends AlertDialog implements DialogInterface
        .OnClickListener, com.example.kevin.sheargear.SimpleDatePickerDelegate.OnDateChangedListener {

    private static final String YEAR = "year";
    private static final String MONTH = "month";

    private com.example.kevin.sheargear.SimpleDatePickerDelegate mSimpleDatePickerDelegate;
    ...
    public SimpleDatePickerDialog(Context context, int theme, OnDateSetListener listener, int year,
        ...
        mSimpleDatePickerDelegate = new com.example.kevin.sheargear.SimpleDatePickerDelegate(view);
